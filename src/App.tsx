...
export default function App(){return <BrowserRouter><AuthProvider><Routes>
  ...
  <Route element={<TenantProtected/>}>
    ...
    <Route path="/app" element={<AdminLayout/>}>
      ...
      <Route path="venues/:id" element={<VenueSchedulePage/>}/>
  ...
  {/* Keep this dynamic public route after every fixed route to avoid swallowing SaaS pages. */}
